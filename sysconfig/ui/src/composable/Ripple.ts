...
const mouseUpRipple = (ripple: HTMLElement) => {
    if(ripple != null) {
        setTimeout(() => {
...
export function useRipple(element: HTMLElement) {
    ...
    element.addEventListener("mouseup", (event) => mouseUpRipple(ripple));
    document.body.addEventListener("mouseup", (event) => mouseUpRipple(ripple));
}
...
export function removeRipple(element: HTMLElement) {
    ...
    element.removeEventListener("mouseup", (event) => mouseUpRipple(ripple));
    document.body.removeEventListener("mouseup", (event) => mouseUpRipple(ripple));
}