package org.masos.embed.sysconfig.model.response;

/**
 * Classe modelo que representa uma rede retornada como resposta para sysconfig.
 */
public class NetworkResponse implements Comparable<NetworkResponse> {
     ...
     */
    public NetworkResponse(String essid, Double frequency, Double quality, Boolean encryption, String password) {
        this.essid = essid;
    ...
    @Override
    public int compareTo(NetworkResponse o) {
